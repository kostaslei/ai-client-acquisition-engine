#from scraper.extractor import extract_structured_chunks, extract_contacts, get_all_links
from scraper.cleaner import select_top_chunks
from scraper.embedder import get_embedding, embed_chunks
from scraper.scorer import rank_chunks
from scraper.config import MAX_CHARS, QUERY
